...
public class MotorcycleList extends ParsableList<Motorcycle> {

    public MotorcycleList() {
    }
    
    public MotorcycleList(int count) {
        super();
        ...
        for (int i = 0; i < count; i++) {
            ...
            add(new Motorcycle(makesAndModels[makeIndex][0], makesAndModels[makeIndex][modelIndex],
                    1994 + rnd.nextInt(20),
    ...
    @Override
    protected Motorcycle createElement(String data) {
